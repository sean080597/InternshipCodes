...
public sendAssignmentResult(assignmentData): Observable<any> {
    return this.httpService.post(`${APIs.assignment.base}/teacher-review-to-complete`, assignmentData)
}

public sendAssignmentEvaluation(evaluateData): Observable<any> {
    return this.httpService.post(`${APIs.assignment.base}/teacher-evaluate`, evaluateData)
}
