...
@Component
public class MessageConsumer1 implements ApplicationRunner {
    ...
    @KafkaListener(id = "MessageConsumer1", topics = "topic-demo", autoStartup = "false")
    public void listen(ConsumerRecord<String, String> record) {
        logger.info("Consumer1 consume the message: {} - {}", record.key(), record.value());
    }
