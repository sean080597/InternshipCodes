...
<!-- =========================   Add some custom for this page   =====================  -->
	<link rel="stylesheet" href="<?php echo _root_dirname; ?>/petition/css/petition_dashboard.css">
...
<body style="display:none">
	...
	<div id="wrapper">
		...
		<div class="row main_content">
			<div class="col-md-offset-1 col-md-10 middle_content">
				<h1 class="page_title col-md-12">Dashboard</h1>
				<div class="col-md-8 left_content">
					<div class="content_dashboard col-md-12">
						<div class="dashboard_myPetition">
							<h2 class="pull-left">Thỉnh Nguyện Thư Của Tôi</h2>
							<form action="" id="formSearch" class="pull-right">
								<input type="text" class="txtSearch" placeholder="Search">
  								<input title="Search" value="" type="submit" class="btnSearch" disabled>
							</form>
						</div>
						<ul id="my_petition_list">
							<!-- <li class="my_petition clearfix">
								<div class="col-md-3 img_wrapper">
									<img src="<?php echo _root_dirname; ?>/upload/images/fight_0.png" alt="">
								</div>
								<div class="my_petition_info col-md-9">
									<h3><a href="https://www.ipetitions.com/petition/chc-d-tin" target="_blank" id="petition_title">Petition Title</a></h3>
									...
									<div class="row_buttons">
										<div class="sign_target_count">
											<span class="signs">4</span>/<span class="target">1,000</span>
										</div> -->
				...
				<div class="col-md-4 right_content">
					<aside>
						<div class="aside_donate">
							<div class="donate_title">Your contribution is vital!</div>
							<div class="donate_caption">It allows us to host thousands<br>of free petitions like yours.</div>
							<a href="" class="btn btn-default btn_donate" id="btn_donate">Đóng Góp</a>
						</div>
						<div class="description">
							<div class="myprofile_header">
								<h2>Thông Tin Của Tôi</h2>
							</div>
							<div class="myprofile_body">
								<!-- <img src="<?php echo _root_dirname; ?>/upload/congtrinh/default_avatar.jpg" alt="" class="user_pic">
								<h3>cam cam</h3>
								<a href="/my/account" class="edit_profile">Chỉnh Sửa Thông Tin</a> -->
							</div>
						</div>
					</aside>
				</div>
	...
	<script src="<?php echo _root_dirname; ?>/petition/js/petition_dashboard.js" type="text/javascript"></script>
