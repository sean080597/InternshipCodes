<?php
	...
	if (!isset($_SESSION["LegalRegistration"])) {
		header("location:petition_registration.php");
	}
...
<!-- =========================   Add some custom for this page   =====================  -->
	<link rel="stylesheet" href="<?php echo _root_dirname; ?>/petition/css/petition_confirmation.css">
	<link rel="stylesheet" href="<?php echo _root_dirname; ?>/petition/css/style.css">
	<script src="<?php echo _root_dirname; ?>/petition/js/petition_confirmation.js" type="text/javascript"></script>
<!-- ================================================================================  -->
...
<body style="display:none">
	...
	<div id="wrapper">
		...
		<!--Content-->
		<div class="row">
			<div class="col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8 middle_content">
				<div class="top_congrat_content col-md-offset-2 col-md-8 col-xs-12">
		            <p class="congrat">Congratulations!</p>
		            <!-- <p>Your petition is now live at 
		            	<a href="" class="petitionAddr" style="word-break: break-all;">https://www.ipetitions.com/petition/khong-d-tin</a>
		            </p> -->
		            <p>Thỉnh Nguyện Thư của bạn đang được chờ duyệt</p>
		            <p>Bạn có thể quản lý Thỉnh Nguyện Thư bằng cách đăng nhập vào trang <a href="<?php echo _root_dirname; ?>/petition/petition_dashboard.php">QUẢN LÝ</a> của bạn</p>

		            <h1 class="share-success">Chia sẻ để đạt được đủ chữ ký nhanh hơn!</h1>
		        </div>
		        <div class="tabs-wrapper">
		            <!-- Tab panes -->
		            <div class="tab-content">
	                	<div class="petition_preview col-md-offset-2 col-md-8">
	                		<!-- Here is petition preview after successful registration -->
	                	</div>
	                </div>
		        </div>
			</div>
