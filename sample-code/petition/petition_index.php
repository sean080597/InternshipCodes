...
<!-- =========================   Add some custom for this page   =====================  -->
	<link rel="stylesheet" href="<?php echo _root_dirname; ?>/petition/css/petition_index.css">
	...
	<script src="<?php echo _root_dirname; ?>/petition/js/accounting.min.js"></script>
<!-- ================================================================================  -->
...
<body style="display:none">
	...
	<div id="wrapper">
		...
		<div class="row main_content">
			<div class="col-md-offset-2 col-md-8 middle_content">
				<h1 class="page_title col-md-12">Danh Sách Thỉnh Nguyện Thư</h1>
				<div class="col-md-12 left_content">
					<div class="content_dashboard col-md-12">
						<div class="dashboard_myPetition">
							...
							<div class="pull-right" id="count_all_signed">
								<span class="all_signed"></span><span> Chữ Ký</span>
							</div>
						</div>
	...
	<script src="<?php echo _root_dirname; ?>/petition/js/petition_index.js" type="text/javascript"></script>
